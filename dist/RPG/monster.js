...
exports.Places = [
    {
        ...
        monster: [],
        foragable: [
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.20 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.07 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.04 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.03 },
