...
exports.Places = [
    {
        ...
        foragable: [
            ...
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("trash", 1), chance: 0.3 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.1 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("trash", 1), chance: 0.08 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.05 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("trash", 1), chance: 0.06 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.05 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("trash", 1), chance: 0.04 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("stone", 1), chance: 0.02 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("trash", 1), chance: 0.02 },
            ...
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("money1", 1), chance: 0.02 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("money1", 3), chance: 0.01 },
        ],
        //npcs:[],
        ...
        foragable: [
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("wheat", 5), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("wheat", 2), chance: 0.02 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("wheat", 1), chance: 0.09 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("wheat", 1), chance: 0.20 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("wheat", 1), chance: 0.08 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("wheat", 1), chance: 0.06 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("tomato", 3), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("tomato", 1), chance: 0.09 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("tomato", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("tomato", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("cucumber", 3), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("cucumber", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("cucumber", 1), chance: 0.09 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("cucumber", 1), chance: 0.09 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("cucumber", 1), chance: 0.03 },
            { val: itemdb_1.BeeItemDB.createStackByCanonicalId("cabage", 3), chance: 0.002 }, //4
        ],
