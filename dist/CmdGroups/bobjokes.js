...
exports.BobCommands = [
    {
        ...
        cmd(msg) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield sleep(1800);
                yield msg.reply(jokes[Math.floor(Math.random() * jokes.length)]);
                if (Math.random() < .9) {
                    let tch = yield app_1.clientBee.channels.fetch(msg.channel.id);
                    yield tch.sendTyping();
                    yield sleep(3000);
                    let beesmsg = yield tch.send("Stop telling such terrible jokes (╬ ಠ益ಠ)");
                    yield msg.channel.sendTyping();
                    yield sleep(3000);
                    let bobMsg = yield msg.channel.send({
                        content: "make me stop ┌( ಠ_ಠ)┘",
                        reply: { messageReference: beesmsg }
                    });
                    yield sleep(3000);
                    beesmsg = yield tch.send({
...
//# sourceMappingURL=bobjokes.js.map